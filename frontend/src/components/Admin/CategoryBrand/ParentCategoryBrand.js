...
import {
  createParentCategoryBrandAsync,
  deleteParentCategoryBrandAsync,
  getParentCategoryBrandAsync,
  updateParentCategoryBrandAsync,
} from "../../../Redux/AdminSlices/CategoryBrand/parentCategoryBrandSlice";

const ParentCategoryBrand = () => {
  ...
  async function fetchParentFilter() {
    ...
    const data = await dispatch(getParentCategoryBrandAsync());
    // console.log("data parent catregory brand ", data);
  ...
  async function deleteHandler(event, id) {
    ...
    if (window.confirm("Are you sure want to Delete It ?")) {
      const actionResult = await dispatch(
        deleteParentCategoryBrandAsync({ id })
      );
                ...
                <form onSubmit={handleSubmit}>
                  <div className="form-group mb-3">
                    <div className="d-flex align-items-baseline">
                      <label htmlFor="filterName">Parent Category Name</label>
...
export default ParentCategoryBrand;
